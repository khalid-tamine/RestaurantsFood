...
export default function Home({navigation}) {
    ...
    function onSelectCategory(category) {
        //filter restaurant
        let restaurantList = restaurantData.filter(m => m.categories.includes(category.id));
        ...
        const renderItem = ({ item }) => {
            return (
                ...
                >
                    ...
                    <Text style = {{ marginTop: SIZES.padding, color: (selectedCategory?.id == item.id)?COLORS.white:COLORS.black , ...FONTS.h4 }}>{item.name}</Text>
                </TouchableOpacity>
            )
            }
        return (
            <View style= {{ paddingLeft : 7}}>
                <Text style = {{ ...FONTS.h3, fontSize: 17 , paddingLeft : 13, paddingTop :10 }}>Categories</Text>
                <FlatList
                    data = {categories}
                    horizontal
        ...
        const renderItem = ({ item }) => (
            ...
            >
                ...
                <View style = {{ marginBottom: SIZES.padding }}>
                    ...
                    <View style = {{ position: 'absolute', bottom: 0, height: 50, width: SIZES.width * 0.3, backgroundColor: COLORS.white, borderTopRightRadius: SIZES.radius, borderBottomLeftRadius: SIZES.radius, alignItems: 'center', justifyContent: 'center', ...styles.shadow }}>
                ...
                <View style = {{ marginTop: SIZES.padding, flexDirection: 'row' }}>
                    {/* Rating Details */}
                    <Image source={icons.star} style = {{ width: 20, height: 20, tintColor: COLORS.primary, marginRight: 10 }} />
                    ...
                    <View style = {{ flexDirection: 'row', marginLeft: 10 }}>
                        ...
                        <Text style = {{ ...FONTS.body3 }}>{item.priceRating}</Text>
